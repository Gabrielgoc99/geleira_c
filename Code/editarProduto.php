...
require_once 'conexao.php';
	...
	if(isset($_GET['codigo'])):
		...
		$codigo = mysqli_escape_string($conexao, $_GET['codigo']);
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.min.js" integrity="sha384-wfSDF2E50Y2D1uUdj0O3uMBJnjuUD4Ih7YwaYd1iqfktj0Uod8GCExl3Og8ifwB6" crossorigin="anonymous"></script>
    ...
    <center>
        ...
        <form action = "updateProduto.php" method="POST">
            ...
            <p> Modelo: <input type="text" name="modelo" id="modelo" label="Modelo" value="<?php echo $dado['modelo'];?>"> </p>
            <p> Marca: <input type="text" value="<?php echo $dado['marca'];?>" name="marca" id="marca" label="Marca"> </p>
            <p> Valor: <input type="text" name="valor" id="valor" label="Valor" value="<?php echo $dado['valor'];?>"> </p>
