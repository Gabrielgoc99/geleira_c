...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.min.js" integrity="sha384-wfSDF2E50Y2D1uUdj0O3uMBJnjuUD4Ih7YwaYd1iqfktj0Uod8GCExl3Og8ifwB6" crossorigin="anonymous"></script>
    ...
    <center>
        ...
        <form action = "updateFuncionario.php" method="POST">
			<input type="hidden" name="matricula" value="<?php echo $dado['matricula'];?>">
            <h2>Editar Funcionário</h2>
            
            
            <p> Nome: <input type="text" name="nome" id="nome" label="Nome" value="<?php echo $dado['nome'];?>"> </p>
            <p> CPF: <input type="text" value="<?php echo $dado['cpf'];?>" name="cpf" id="cpf" label="CPF"> </p>
            <p> Telefone: <input type="text" name="telefone" id="telefone" label="Telefone" value="<?php echo $dado['telefone'];?>"> </p>
            <p> Data de Nascimento: <input type="date" name="dataNascimento" id="dataNascimento" label="DataNascimento" value="<?php echo $dado['dataNascimento'];?>"> </p>
            <p> Usuário: <input type="text" name="usuario" id="usuario" label="Usuario" maxlength="8" value="<?php echo $dado['usuario'];?>"> </p>
            <p> Senha: <input type="text" name="senha" id="senha" label="senha" maxlength="8" value="<?php echo $dado['senha'];?>"> </p>
            
            <center> 
            <div class="col-sm-10">
                <button type="submit" name="btn-editar" class="btn btn-primary" onclick="submit()">Atualizar</button>
